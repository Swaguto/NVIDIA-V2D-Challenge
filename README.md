...
The full runbook is in [`docs/team/issue1/README_ISSUE1.md`](docs/team/issue1/README_ISSUE1.md).
5-minute version:

```bash
# 1. Provision a GPU box (A100 / H100 / L40S — NOT Blackwell). Then:
bash docs/team/issue1/bootstrap_cloud.sh              # GPU + Docker + toolkit + repo clone
sudo reboot                                      # only if it installed a driver
bash docs/team/issue1/bootstrap_cloud.sh --with-reconstruction
...
Verified smoke-test MP4s live in [`docs/team/issue1/`](docs/team/issue1/):
[`sharpa_smoke.mp4`](docs/team/issue1/sharpa_smoke.mp4) (Sharpa floating hand)
and [`g1_smoke.mp4`](docs/team/issue1/g1_smoke.mp4) (G1 whole body).
